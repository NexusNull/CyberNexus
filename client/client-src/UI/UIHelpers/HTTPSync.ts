import {BaseFileSystem, FileSystem, BFSCallback, FileSystemOptions} from 'browserfs/src/core/file_system';
import {ApiError, ErrorCode} from 'browserfs/src/core/api_error';
import {FileFlag, ActionType} from 'browserfs/src/core/file_flag';
import {copyingSlice} from 'browserfs/src/core/util';
import {File} from 'browserfs/src/core/file';
import Stats from 'browserfs/src/core/node_fs_stats';
import {NoSyncFile} from 'browserfs/src/generic/preload_file';
import {asyncDownloadFile, syncDownloadFile, getFileSizeAsync, getFileSizeSync} from 'browserfs/src/generic/xhr';
import {FileIndex, isFileInode, isDirInode} from 'browserfs/src/generic/file_index';
...
export default class HTTPRequest extends BaseFileSystem implements FileSystem {
     ...
     */
    public readFile(fname: string, encoding: BufferEncoding, flag: FileFlag, cb: BFSCallback<string | Buffer>): void {
